...
namespace CoreSpatial.Analysis.Tyson.Core
{
	/// <summary>
	...
	internal class Voronoi
	{
		...
		private TysonGeoPoint PQ_min()
		{
			TysonGeoPoint answer = new TysonGeoPoint();
		...
		private Halfedge ELleftbnd(TysonGeoPoint p)
		{
			int bucket;
			Halfedge he;
		...
		private void pushGraphEdge(Site leftSite, Site rightSite, double x1, double y1, double x2, double y2)
		{
			...
			newEdge.Point1Index = leftSite.sitenbr;
			newEdge.Point2Index = rightSite.sitenbr;
		}
		...
		private bool right_of(Halfedge el, TysonGeoPoint p)
		{
			Edge e;
			Site topsite;
			bool right_of_site;
